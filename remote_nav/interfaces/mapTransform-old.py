...
class Ui_Window(object):
    ...
    ## toggleRobot - QCheckbox
        ...
        Window.setTabOrder(self.tools, self.point1)
        ...
        Window.setTabOrder(self.point3, self.p1_x2)
        Window.setTabOrder(self.p1_x1, self.p1_y1)
        Window.setTabOrder(self.p1_y1, self.p2_x1)
        Window.setTabOrder(self.p1_x2, self.p1_y2)
        Window.setTabOrder(self.p1_y2, self.p2_x1)
    ...
    def retranslateUi(self, Window):
        ...
        self.p1_x1.setPlaceholderText(QtGui.QApplication.translate("Window", "X1", None, QtGui.QApplication.UnicodeUTF8))
        self.p1_y1.setPlaceholderText(QtGui.QApplication.translate("Window", "Y1", None, QtGui.QApplication.UnicodeUTF8))
        self.p1_x2.setPlaceholderText(QtGui.QApplication.translate("Window", "X2", None, QtGui.QApplication.UnicodeUTF8))
        self.p1_y2.setPlaceholderText(QtGui.QApplication.translate("Window", "Y2", None, QtGui.QApplication.UnicodeUTF8))
        self.point2.setText(QtGui.QApplication.translate("Window", "Point 2", None, QtGui.QApplication.UnicodeUTF8))
        self.p2_x1.setPlaceholderText(QtGui.QApplication.translate("Window", "X1", None, QtGui.QApplication.UnicodeUTF8))
        self.p2_y1.setPlaceholderText(QtGui.QApplication.translate("Window", "Y1", None, QtGui.QApplication.UnicodeUTF8))
        self.p2_x2.setPlaceholderText(QtGui.QApplication.translate("Window", "X2", None, QtGui.QApplication.UnicodeUTF8))
        self.p2_y2.setPlaceholderText(QtGui.QApplication.translate("Window", "Y2", None, QtGui.QApplication.UnicodeUTF8))
        self.point3.setText(QtGui.QApplication.translate("Window", "Point 3", None, QtGui.QApplication.UnicodeUTF8))
        self.p3_x1.setPlaceholderText(QtGui.QApplication.translate("Window", "X1", None, QtGui.QApplication.UnicodeUTF8))
        self.p3_y1.setPlaceholderText(QtGui.QApplication.translate("Window", "Y1", None, QtGui.QApplication.UnicodeUTF8))
        self.p3_x2.setPlaceholderText(QtGui.QApplication.translate("Window", "X2", None, QtGui.QApplication.UnicodeUTF8))
        self.p3_y2.setPlaceholderText(QtGui.QApplication.translate("Window", "Y2", None, QtGui.QApplication.UnicodeUTF8))
